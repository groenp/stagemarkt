                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter"
                                    ...
                                    <tr>
                                        <td valign="top" class="footerContent" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;color: #777777;font-family: Helvetica;font-size: 10px;line-height: 125%;padding-top: 0;padding-right: 20px;padding-bottom: 0;padding-left: 20px;text-align: left;">
                                            ...
                                            <a href="<?php echo trailingslashit(admin_url()) ?>" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;color: #606060;font-weight: normal;text-decoration: underline;white-space: nowrap;">Sites Management Tool</a>.<br>
                                            Groen Productions has a <a href="<?php echo site_url('/privacy_and_terms_of_use.php') ?>" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;color: #606060;font-weight: normal;text-decoration: underline;white-space: nowrap;">Privacy Statement</a>.<br>
                                            <br>
